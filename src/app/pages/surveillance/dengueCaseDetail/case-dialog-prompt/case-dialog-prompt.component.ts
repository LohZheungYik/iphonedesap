...
@Component({
  selector: 'ngx-case-dialog-prompt',
  templateUrl: 'case-dialog-prompt.component.html',
  styleUrls: ['case-dialog-prompt.component.scss'],
})
...
export class CaseDialogComponent {
  ...
  constructor(@Inject(NB_AUTH_OPTIONS) protected options = {}, private cd: ChangeDetectorRef, protected ref: NbDialogRef<CaseDialogComponent>,
  ...
  submit() {
    ...
    this.ovitrap.denguecase = this.caseID;

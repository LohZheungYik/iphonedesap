...
export const MENU_ITEMS: NbMenuItem[] = [
  ...
  },
  {
    ...
    children: [
      {
        title: 'Reported Dengue Case',
        icon: 'icon ion-ios-folder-open',
        link: '/pages/surveillance/denguecase',
      },
      {
        title: 'Mosquito Home Sentinel',
        icon: 'icon ion-md-nuclear',
        link: '/pages/surveillance/ovitrapsentinel',
      },
    ]
  },
  {
    ...
    children: [
      {
        title: 'Historical Mosquito Home Map',
        icon: 'nb-location',
        link: '/pages/maps/historical',
      },
      {
        title: 'Prediction Map',
        icon: 'nb-location',
        link: '/pages/maps/prediction',
      },
    ]
  },
  {
